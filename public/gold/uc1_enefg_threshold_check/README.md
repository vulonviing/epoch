# uc1_enefg_threshold_check public gold

This directory is a structure-only disclosure copy of frozen gold `v002`.
It contains 10 checkpoint schemas and a value-redacted supporting
